...
function setup() {
	...
	//Create the Bodies Here.
	  ...
	  mango1=new Mango(1300,50,20); 
	  mango2=new Mango(1300,200,20); 
	  mango3=new Mango(1100,180,20); 
	  mango4=new Mango(1100,180,20); 
	  mango5=new Mango(1200,110,20); 
	  mango6=new Mango(1400,110,20);
	  mango7=new Mango(1450,190,20);
